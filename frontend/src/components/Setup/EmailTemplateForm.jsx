// src/components/EmailTemplateForm.jsx
...
const EmailTemplateForm = () => {
  const { setTemplates } = useContext(EmailTemplateContext);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://localhost:3000/api/email-templates', formData);
